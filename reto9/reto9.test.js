...
const result1 = countTime([0, 1, 1, 0, 1]); // 7
const result2 = countTime([0, 0, 0, 1]); // 21
const result3 = countTime([0, 0, 1, 0, 0]); // 28

test('reto4Test', () => {
	expect(result1).toStrictEqual(7);
	expect(result2).toStrictEqual(21);
	expect(result3).toStrictEqual(28);
});
